...
public:
    ...
    void setupUi(QWidget *AddressBookPage)
    {
        ...
        AddressBookPage->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bkg);"));
        ...
        tableView->setStyleSheet(QString::fromUtf8("background-color: rgb(106, 131, 154);"));
        ...
        newAddressButton->setStyleSheet(QString::fromUtf8("background-color: rgb(106, 131, 154);\n"
"background-image: url(:/images/bgbfree);"));
        ...
        copyToClipboard->setStyleSheet(QString::fromUtf8("background-color: rgb(106, 131, 154);background-image: url(:/images/bgbfree);"));
        ...
        showQRCode->setStyleSheet(QString::fromUtf8("background-color: rgb(106, 131, 154);background-image: url(:/images/bgbfree);"));
        ...
        signMessage->setStyleSheet(QString::fromUtf8("background-color: rgb(106, 131, 154);background-image: url(:/images/bgbfree);"));
        ...
        verifyMessage->setStyleSheet(QString::fromUtf8("background-color: rgb(106, 131, 154);background-image: url(:/images/bgbfree);"));

        horizontalLayout->addWidget(verifyMessage);

        deleteButton = new QPushButton(AddressBookPage);
        deleteButton->setObjectName(QString::fromUtf8("deleteButton"));
        deleteButton->setStyleSheet(QString::fromUtf8("background-color: rgb(106, 131, 154);background-image: url(:/images/bgbfree);"));
...
"background-color: rgb(106, 131, 154);"));
    ...
    void retranslateUi(QWidget *AddressBookPage)
    {
        ...
        labelExplanation->setText(QApplication::translate("AddressBookPage", "These are your LitecoinBolt addresses for receiving payments. You may want to give a different one to each sender so you can keep track of who is paying you.", 0, QApplication::UnicodeUTF8));
...
#ifndef QT_NO_TOOLTIP
        signMessage->setToolTip(QApplication::translate("AddressBookPage", "Sign a message to prove you own a LitecoinBolt address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        signMessage->setText(QApplication::translate("AddressBookPage", "Sign &Message", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        verifyMessage->setToolTip(QApplication::translate("AddressBookPage", "Verify a message to ensure it was signed with a specified LitecoinBolt address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
