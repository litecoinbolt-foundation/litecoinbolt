...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        RPCConsole->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bkg);"));
        ...
        openDebugLogfileButton->setStyleSheet(QString::fromUtf8("background-color: rgb(106, 131, 154);"));
        ...
        showCLOptionsButton->setStyleSheet(QString::fromUtf8("background-color: rgb(106, 131, 154);"));
...
"background-image: url(:/images/bgbfree);"));
        ...
        btnClearTrafficGraph->setStyleSheet(QString::fromUtf8("background-color: rgb(106, 131, 154);\n"
"background-image: url(:/images/bgbfree);"));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "LitecoinBolt - Debug window", 0, QApplication::UnicodeUTF8));
        label_9->setText(QApplication::translate("RPCConsole", "LitecoinBolt Core", 0, QApplication::UnicodeUTF8));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the LitecoinBolt debug log file from the current data directory. This can take a few seconds for large log files.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the LitecoinBolt-Qt help message to get a list with possible LitecoinBolt command-line options.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
