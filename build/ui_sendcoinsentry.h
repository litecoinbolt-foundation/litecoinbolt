...
public:
    ...
    void setupUi(QFrame *SendCoinsEntry)
    {
        ...
        SendCoinsEntry->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bkg);"));
        ...
        payAmount->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));

        gridLayout->addWidget(payAmount, 5, 1, 1, 1);

        label_4 = new QLabel(SendCoinsEntry);
        label_4->setObjectName(QString::fromUtf8("label_4"));
        label_4->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));
        ...
        payTo->setStyleSheet(QString::fromUtf8("background-image: url(:/images/gr);"));
        ...
        addressBookButton->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);\n"
"background-color: rgb(106, 131, 154);"));
        ...
        pasteButton->setStyleSheet(QString::fromUtf8("background-color: rgb(106, 131, 154);\n"
"background-image: url(:/images/bgbfree);"));
        ...
        deleteButton->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);\n"
"background-color: rgb(106, 131, 154);"));
        QIcon icon2;
        ...
        addAsLabel->setStyleSheet(QString::fromUtf8("background-image: url(:/images/gr);"));
    ...
    void retranslateUi(QFrame *SendCoinsEntry)
    {
        ...
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The address to send the payment to (e.g. JgZaH1DdikpMTYc2x1Xb6eFBkKGibjmPb9)", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
