...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        OptionsDialog->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bkg);"));
        OptionsDialog->setModal(true);
        verticalLayout = new QVBoxLayout(OptionsDialog);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        tabWidget = new QTabWidget(OptionsDialog);
        tabWidget->setObjectName(QString::fromUtf8("tabWidget"));
        tabWidget->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bkg);"));
        ...
        transactionFeeInfoLabel->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));
        ...
        transactionFeeLabel->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));
        ...
        reserveBalanceInfoLabel->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));
        ...
        reserveBalanceLabel->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));
        ...
        bitcoinAtStartup->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));
        ...
        mapPortUpnp->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));
        ...
        connectSocks->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));
        ...
        proxyIpLabel->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));
        ...
        proxyIp->setStyleSheet(QString::fromUtf8("background-color: rgb(106, 131, 154);"));
        ...
        proxyPortLabel->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));
        ...
        proxyPort->setStyleSheet(QString::fromUtf8("background-color: rgb(106, 131, 154);"));
        ...
        socksVersionLabel->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));
        ...
        minimizeToTray->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));
        ...
        minimizeOnClose->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));
        ...
        langLabel->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));
        ...
        unitLabel->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));
        ...
        coinControlFeatures->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));
        ...
        minimizeCoinAge->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));
        ...
        useBlackTheme->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));
        ...
        statusLabel->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bgbfree);"));
        ...
        okButton->setStyleSheet(QString::fromUtf8("background-color: rgb(106, 131, 154);background-image: url(:/images/bgbfree);"));

        horizontalLayout_Buttons->addWidget(okButton);

        cancelButton = new QPushButton(OptionsDialog);
        cancelButton->setObjectName(QString::fromUtf8("cancelButton"));
        cancelButton->setStyleSheet(QString::fromUtf8("background-color: rgb(106, 131, 154);background-image: url(:/images/bgbfree);"));
        ...
        applyButton->setStyleSheet(QString::fromUtf8("background-color: rgb(106, 131, 154);background-image: url(:/images/bgbfree);"));
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start LitecoinBolt after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start LitecoinBolt on system login", 0, QApplication::UnicodeUTF8));
        tabWidget->setTabText(tabWidget->indexOf(tabMain), QApplication::translate("OptionsDialog", "&Main", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the LitecoinBolt client port on the router. This only works when your router supports UPnP and it is enabled.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the LitecoinBolt network through a SOCKS proxy (e.g. when connecting through Tor).", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting LitecoinBolt.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
